                            ...
                            <form class="forms-sample"action="{{ route('blogs.store') }}" method="POST"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('youtube_link') is-invalid @enderror"
                                        id="name" name="youtube_link" value="{{ old('youtube_link') }}">
                                    @error('youtube_link')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                {{-- <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('meta_title') is-invalid @enderror"
                                        id="name" name="meta_title" value="{{ old('meta_title') }}">
                                    @error('meta_title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div> --}}
                                ...
                                {{-- <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('meta_keywords') is-invalid @enderror"
                                        id="name" name="meta_keywords" value="{{ old('meta_keywords') }}">
                                    @error('meta_keywords')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div> --}}
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col">
                                        ...
                                        <textarea class="form-control @error('meta_description') is-invalid @enderror" name="meta_description"
                                            id="description1">{{ old('meta_description') }}</textarea>
