    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Feature Album</h4>
                        <div style="display: flex;justify-content: end;"><a
                                href="{{ route('feature-album.create') }}" class="btn btn-primary">Create New</a></div>
...
@push('script')
    ...
    <script>
        ...
        function deleteItem(id) {
            var url = '{{ route('feature-album.delete', ':id') }}';
