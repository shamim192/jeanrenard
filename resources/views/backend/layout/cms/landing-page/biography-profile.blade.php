...
@section('title', 'Biography Profile')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Biography Profile Section</h4>
                        {{-- delete image --}}
                        <div class="d-flex justify-content-end mb-4">
                            <form action="{{ route('cms.landing-page.delete.image') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('DELETE')
                        ...
                        <div class="mt-4">
                            <form action="{{ route('cms.landing-page.biography.profile.update') }}" method="POST"
