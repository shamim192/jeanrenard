    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Biography Section</h4>
                        <div class="mt-4">
                            <form action="{{ route('cms.landing-page.biography.update') }}" method="POST"
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Button Link" name="link_url" value="{{ $data[1]->link_url }}">
                                        @error('link_url')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
