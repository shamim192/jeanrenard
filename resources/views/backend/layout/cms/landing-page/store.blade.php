    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Store Section</h4>
                        <div class="mt-4">
                            <form action="{{ route('cms.landing-page.store.update') }}" method="POST"
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Sub Title" name="sub_title" value="{{ $data[3]->sub_title }}">
                                        @error('sub_title')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col">
                                        <label class="form-lable">Button Link</label>
                                        <input type="text"
                                            class="form-control form-control-md border-left-0 @error('link_url') is-invalid @enderror"
                                            placeholder="Button Link" name="link_url" value="{{ $data[3]->link_url }}">
                                        @error('link_url')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
