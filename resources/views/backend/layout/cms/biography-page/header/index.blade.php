            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <form action="{{ route('cms.biography-page.header.update') }}" method="POST"
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col">
                                        ...
                                        <input class="form-control dropify @error('image_url') is-invalid @enderror"
                                            type="file"
                                            data-default-file="{{ $data[0]->image_url ? asset('storage/' . $data[0]->image_url) : asset('backend/images/placeholder/image_placeholder.png') }}"
                                            name="image_url">
