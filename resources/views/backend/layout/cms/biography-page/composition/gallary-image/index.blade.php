                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div style="display: flex;justify-content: end;"><a
                                href="{{ route('biography.composition.gallary-image.create') }}" class="btn btn-primary">Create New</a></div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('biography.composition.gallary-image.index') }}",
                        type: "get",
                    },
        ...
        function deleteItem(id) {
            var url = '{{ route('biography.composition.gallary-image.delete', ':id') }}';
