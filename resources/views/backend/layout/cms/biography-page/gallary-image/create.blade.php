            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <form class="forms-sample"action="{{ route('biography.gallary-image.store') }}" method="POST"
                                ...
                                <a href="{{ route('biography.gallary-image.index') }}" class="btn btn-danger ">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
