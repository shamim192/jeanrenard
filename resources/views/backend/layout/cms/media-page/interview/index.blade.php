                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div style="display: flex;justify-content: end;"><a
                                href="{{ route('cms.media-page.interview.create') }}" class="btn btn-primary">Create New</a></div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('cms.media-page.interview.index') }}",
                        type: "get",
                    },
        ...
        function deleteItem(id) {
            var url = '{{ route('cms.media-page.interview.delete', ':id') }}';
