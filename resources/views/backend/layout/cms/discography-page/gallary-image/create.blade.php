            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <form class="forms-sample"action="{{ route('discography.gallary-image.store') }}" method="POST"
                                ...
                                <a href="{{ route('discography.gallary-image.index') }}" class="btn btn-danger ">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
