...
@section('title', 'Discography Header')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Discography Header Section</h4>
                        {{-- delete image --}}
                        ...
                        <div class="mt-4">
                            <form action="{{ route('cms.discography-page.header.update') }}" method="POST"
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col">
                                        ...
                                        <input class="form-control dropify @error('image_url') is-invalid @enderror"
                                            type="file"
                                            data-default-file="{{ $data[8]->image_url ? asset('storage/' . $data[8]->image_url) : asset('backend/images/placeholder/image_placeholder.png') }}"
                                            name="image_url">
