            ...
            <div class="stream-container">
                ...
                <div class="stream-left">
                    <div class="stream--content--left">
                        ...
                        <div class="stream-link-btn-container" class="d-flex">
                            <a class="stream-link-btn" href="#">
                                {{ $cms[0]->button_text ? $cms[0]->button_text : 'Stream' }}
                                <svg class="big-arrow" xmlns="http://www.w3.org/2000/svg" width="43" height="11" viewBox="0 0 43 11"
                                    fill="none">
                                    <path
