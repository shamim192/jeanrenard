                        ...
                        <form action="{{ route('contact.send') }}" method="POST">
                            ...
                            <div class="contact-us-terms">
                                <div class="form-check d-flex">
                                    <input type="checkbox"
                                        class="form-check-input form-check-contact @error('agreeTerms') is-invalid @enderror"
                                        id="agreeTerms" name="agreeTerms" required>
                                    <span>Agree to the <a class="signup-terms" href="javascript:void(0)">terms and
                                            conditions</a> and choose to receive promotional emails, newsletters, and other
                                        updates.</span>
                                    @error('agreeTerms')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
