...
class GallaryImageController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = GallaryImage::where('gallary_id', 2)->get();
        ...
        return view('backend.layout.cms.biography-page.gallary-image.index');
    }

    public function create()
    {
        return view('backend.layout.cms.biography-page.gallary-image.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image_url')) {
            ...
            $image_url = uploadImage($image, 'images/cms/biography/gallary'); // Define your uploadImage function
        }
