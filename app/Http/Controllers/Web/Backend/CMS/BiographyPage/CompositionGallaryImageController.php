...
class CompositionGallaryImageController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            $data = GallaryImage::where('gallary_id', 3)->get();
        ...
        return view('backend.layout.cms.biography-page.composition.gallary-image.index');
    }

    public function create()
    {
        return view('backend.layout.cms.biography-page.composition.gallary-image.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image_url')) {
            ...
            $image_url = uploadImage($image, 'images/cms/compostion/gallary'); // Define your uploadImage function
        }
